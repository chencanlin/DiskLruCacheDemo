package com.ccl.perfectisshit.disklrucachedemo;
...
public class DiskLruCacheDemoActivity extends Activity {
    ...
    private void initData() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                File diskCacheDir = getDiskCacheDir(DiskLruCacheDemoActivity.this, CACHE_DIR);
                int appVersion = getAppVersion(DiskLruCacheDemoActivity.this);
                try {
